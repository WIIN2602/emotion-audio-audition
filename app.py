...
import pandas as pd
from audprec import audio_recorder # เปลี่ยนมาเรียกใช้ตัวนี้แทน
...
# เรียกใช้งานแบบ audprec (ใช้งานเหมือนกันเลย)
...
if audio_bytes:
    ...
    st.success(f"เมื่อดาวน์โหลดเสร็จแล้ว ไฟล์จะชื่อ: {output_filename}")
